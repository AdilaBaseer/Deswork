sap.ui.define(
  ...
  function (
    ...
    return Controller.extend("VASPP.managerProjects.controller.DetailProjects", {
      formatter: formatter,
      onInit: function () {
        var that = this;
        if (!that.oAddSubTaskInfo) {
          that.oAddSubTaskInfo = sap.ui.xmlfragment(
            ...
            "VASPP.managerProjects.fragment.RegisteraddSubTask",
            that
          );
        ...
        if (!that.oEditSubTaskInfo) {
          that.oEditSubTaskInfo = sap.ui.xmlfragment(
            ...
            "VASPP.managerProjects.fragment.EditSubTask",
            that
          );
        ...
        that.oRouter
          .getRoute("detailProjectsmanager")
        ...
        if (!that.oAddTeamMember) {
          that.oAddTeamMember = sap.ui.xmlfragment(
            "idFragmentTM",
            "VASPP.managerProjects.fragment.RegisterTeamMember",
            that
          );
      ...
      handleFullScreen: function () {
        ...
        this.oRouter.navTo("detailProjectsmanager", { layout: sNextLayout, product: this.id });
      },
      ...
      handleClose: function () {
        ...
        this.oRouter.navTo("masterProjectsmanager", { layout: sNextLayout });
      },
        ...
        if (EditModel.status === "Completed") {
          ...
          if (!this.oAddProjectDialog1) {
            this.oAddProjectDialog1 = sap.ui.xmlfragment(
              "idfragm",
              "VASPP.managerProjects.view.Register",
              this
            );
      ...
      handleAddTaskS: function () {
        ...
        //     }
          ...
          if (Err == 0) {
            ...
            // else if (new Date(this.oAddSubTaskInfo.getContent()[2].getContent()[9].getValue()) > new Date(projectData.attributes.actualEndDate)) {
            //   sap.m.MessageBox.error("End date is greater than Project Extended end date");
            // }
            // else if (new Date(this.oAddSubTaskInfo.getContent()[2].getContent()[9].getValue()) > new Date(projectData.attributes.estimatedEndDate)) {
            ...
            //   sap.m.MessageBox.error("End date is greater than Task End date");
            // }
